...
var fightOrSkip = function() {
  ...
  // enter conditional recursive call 
...
var endGame = function() {
  ...
  // if player money has more than current score add new high score
  ...
  if (playerInfo.money > highScore) {
    ...
    alert(playerInfo.name + " did not beat the high score. " + highScore)
  }
...
var getPlayerName = function() {
  ...
  while (name === "" || name === null) {
    name = prompt("give your robot a name?");
  }
